...
ViewCurve::ViewCurve(UI_Mainwindow *parent)
{
  int i;
...
void ViewCurve::ECGdetectButton()
{
  ...
  // TODO: check if this is correct. I got this from the function
  // function
  int signal_id = 0;
 ...
 // }
  ...
  {
    printf("Heartrate detection is already active for this signal!\n");
	exit(4);
  }
